...
def operacionactualizar():
    print("Inserto en la base de datos")
    tomanuevoid = idactualizar.get()
    tomanuevonombre = actualizarnombre.get()
    tomanuevotelefono = actualizartelefono.get()
    tomanuevoemail = actualizaremail.get()
    cursor.execute('''
        UPDATE contactos SET 
       
        nombre = "'''+tomanuevonombre+'''",
        telefono = "'''+tomanuevotelefono+'''",
        email = "'''+tomanuevoemail+'''"
        WHERE Identificador = '''+tomanuevoid+'''
        
    ''')
    conexion.commit()
    campoactualizarnombre.delete(0, interfaz.END)
    campoactualizartelefono.delete(0, interfaz.END)
    campoactualizaremail.delete(0, interfaz.END)
...
actualizarnombre = interfaz.StringVar(raiz)
actualizartelefono = interfaz.StringVar(raiz)
actualizaremail = interfaz.StringVar(raiz)
idactualizar = interfaz.StringVar(raiz)
...
interfaz.Label(marcoactualizar,text="Introduce el id a actualizar").pack(pady=5)
campoidactualizar = interfaz.Entry(marcoactualizar,textvariable=idactualizar,width=40)
campoidactualizar.pack(pady=5)
interfaz.Label(marcoactualizar,text="Introduce el nuevo nombre").pack(pady=5)
campoactualizarnombre = interfaz.Entry(marcoactualizar,textvariable=actualizarnombre,width=40)
campoactualizarnombre.pack(pady=5)
interfaz.Label(marcoactualizar,text="Introduce el nuevo telefono").pack(pady=5)
campoactualizartelefono = interfaz.Entry(marcoactualizar,textvariable=actualizartelefono,width=40)
campoactualizartelefono.pack(pady=5)
interfaz.Label(marcoactualizar,text="Introduce el nuevo email").pack(pady=5)
campoactualizaremail = interfaz.Entry(marcoactualizar,textvariable=actualizaremail,width=40)
campoactualizaremail.pack(pady=5)
interfaz.Button(marcoactualizar,text="Actualiza registro",width=40,command=operacionactualizar).pack(pady=5)
